...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="wrapper">
            <img class="blog-image" src="{{ $blog->banner_path }}">
            ...
            <?php
                use App\Models\Blog;
                $blogs = Blog::where('category','LIKE','%'.$categories[0].'%')->limit(3)->get();

            ?>
            <div class="container">
                <h1><a class="hover-underline" style="color: red;" href="/{{$categories[0]}}">{{ ucfirst($categories[0]) }}</a> Kategorisindeki Bloglar</h1>
                <div class="like-blogs">
