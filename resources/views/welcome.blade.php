            ...
            <section class="splide" aria-label="Splide Basic HTML Example">
                <div class="splide__track">
                        ...
                        @foreach($blogs as $blog)
                            <?php $categories = explode(",", $blog->category); ?>
                            <li class="splide__slide">
                                <img src="{{ $blog->banner_path }}">
                                <a href="/{{$categories[0]}}/{{ $blog->link }}">{{ $blog->title }} -> Bloga git</a>
                            </li>
                        @endforeach
                        </ul>
                </div>
            ...
            <?php
                ...
                if(isset($categories)){
                    foreach ($categories as $category) {
                        $blogs = Blog::where('category','LIKE','%'.$category["name"].'%')->limit(3)->get();
                        echo '
                            <section>
                                <h2 style="display: flex; gap: 5px;"><a class="category" href="/'.$category["name"].'">'.ucfirst($category["name"]).'</a> Haberleri</h2>
                                <div class="container like-blogs">'; ?>
